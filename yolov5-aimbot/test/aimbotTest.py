...
def run(
        weights=ROOT / 'runs/train/exp9/weights/last.pt',  # model.pt path(s)
        source=ROOT / 'data/images',  # file/dir/URL/glob, 0 for webcam
        data=ROOT / 'runs/train/exp9/hyp.yaml',  # dataset.yaml path
    ...
    # NMS
        ...
        for i, det in enumerate(pred):
            for *xyxy, conf, cls in reversed(det):
                ...
                if label == 'person':
                    #mouse.position = ((x2+x1)/2,(y2+y1)/2 )
